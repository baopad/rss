...
<div id="page">
    <div id="header">
        <h1 style="font-weight: bold;padding: 5px 0;font-size: 1.75em;line-height: 30px;">PHP探针</h1>
    </div>
    ...
    <table width="100%" cellpadding="3" cellspacing="0" align="center">
        <tr>
            <th colspan="4">客户端信息</th>
        </tr>
        <tr>
            <td width="13%">浏览器类型：</td>
            <td colspan="3"><?php echo $_SERVER["HTTP_USER_AGENT"];?></td>
        </tr>
        <tr>
            <td width="13%">IP地址：</td>
            <td width="37%"> <?php echo getIP();?> </td>
            <td width="13%">beiyomh：</td>
            <td width="37%"><?php echo "";?></td>
        </tr>
        <tr>
            <td width="13%">客户端系统：</td>
            <td width="37%"> <?php echo get_user_os();?> </td>
            <td width="13%">客户端浏览器：</td>
            <td width="37%"><?php echo get_user_browser();?></td>
        </tr>
        <tr>
            <td width="13%">浏览器头信息：</td>
            <td width="37%">
              <!--  <?php var_dump(getallheaders()); ?>  --!>
            </td>
            <td width="13%">浏览器语言：</td>
            <td width="37%"><?php echo getenv("HTTP_ACCEPT_LANGUAGE");?></td>
        </tr>
    </table>
    <table width="100%" cellpadding="3" cellspacing="0" align="center">
        <tr>
    ...
    <table width="100%" cellpadding="3" cellspacing="0" align="center">
        ...
        <tr>
            ...
            <td width="18%">
                ...
                $disFuns = get_cfg_var( "disable_functions" );
                ?>
                <?php echo (0!==preg_match("/phpinfo/i",$disFuns))? '<font color="red">×</font>' :"<a href='$phpSelf?act=phpinfo' target='_blank'>PHPINFO</a>";?> </td>
            <td width="32%">PHP版本（php_version）：</td>
            <td width="18%"><?php echo PHP_VERSION;?></td>
        </tr>
        <tr>
            <td>PHP运行方式：</td>
            <td style="white-space: normal;word-break: break-all;"><?php echo strtoupper(php_sapi_name());?></td>
    ...
    <table width="100%" cellpadding="3" cellspacing="0" align="center">
        ...
        <tr>
            ...
            <td width="18%">
                <?php $zend_version = zend_version();if(empty($zend_version)){echo '<font color=red>×</font>';}else{echo $zend_version;}?>
            </td>
            <td width="32%">
                <?php
        ...
        <tr>
            <td>eAccelerator</td>
            <td>
                <?php if((phpversion('eAccelerator'))!=''){echo phpversion('eAccelerator');}else{ echo "<font color=red>×</font>";} ?>
            </td>
            <td>ioncube</td>
            <td>
                <?php if(extension_loaded('ionCube Loader')){   $ys = ioncube_loader_iversion();   $gm = ".".(int)substr($ys,3,2);   echo ionCube_Loader_version().$gm;}else{echo "<font color=red>×</font>";}?>
            </td>
        </tr>
        <tr>
            <td>XCache</td>
            <td>
                <?php if((phpversion('XCache'))!=''){echo phpversion('XCache');}else{ echo "<font color=red>×</font>";} ?>
            </td>
            <td>APC</td>
            <td>
                <?php if((phpversion('APC'))!=''){echo phpversion('APC');}else{ echo "<font color=red>×</font>";} ?>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" cellpadding="3" cellspacing="0" align="center">
        ...
        <tr>
            <td>SQLite 数据库：</td>
            <td>
                <?php if(extension_loaded('sqlite3')) {$sqliteVer = SQLite3::version();echo '<font color=green>√</font>　';echo "SQLite3　Ver ";echo $sqliteVer[versionString];}else {echo isfun("sqlite_close");if(isfun("sqlite_close") == '<font color="green">√</font>') {echo "&nbsp; 版本： ".@sqlite_libversion();}}?>
            </td>
            <td>Hyperwave 数据库：</td>
    ...
    <a id="bottom"></a>
    <div id="footer"> &copy; <?php echo date('Y')?> <a href="http://www.paotung.org" target="_blank">PAOTUNG</a><br />
        This page is maintained and managed by info@paotung.org<br />
        <?php $run_time = sprintf('%0.4f', microtime_float() - $time_start);?>
        Processed in <?php echo $run_time?> seconds. <?php echo memory_usage();?> memory usage. </div>
</div>
</body>
</html>