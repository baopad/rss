    ...
    <div id="gn-content">
        ...
        <div class="gn-header">
            <ul class="gn-header-case">
                ...
                <li class="gn-header-logo"><a href="<?php echo "$lang";?>">PAOTUNG</a></li>
        ...
        <div class="gn-list">
            <ul class="gn-list-case">
                <li class="gn-list-item gn-list-logo"> <a href="<?php echo "$lang";?>">PAOTUNG</a></li>
                <li class="gn-list-item"><a href="<?php echo "$lang";?>">文档</a></li>
                <li class="gn-list-item"><a href="<?php echo "$lang";?>">资源</a> </li>
                ...
                <li class="gn-list-item"><a href="<?php echo "$lang";?>">教程</a></li>
                <li class="gn-list-item"><a href="<?php echo "$lang";?>/lamp/">LAMP</a></li>
            ...
            <ul class="gn-secondary-case">
                ...
                <li class="gn-secondary-product">
                    ...
                    <ul class="gn-secondary-product-list">
                        ...
                        <li class="gn-secondary-product-list-item"><a href="<?php echo "$lang";?>">网络储存</a></li>
                        <li class="gn-secondary-product-list-item"><a href="<?php echo "$lang";?>">个人空间</a></li>
                        <li class="gn-secondary-product-list-item"><a href="<?php echo "$lang";?>">更多产品</a></li>
                    </ul>
                </li>
