<?php echo @("用户名：" . $_COOKIE[ "user_name" ] . "状态：" . $_COOKIE[ "user_status" ] ); ?>
<!doctype html>
...
<?php // 区域页头样式（二级） ?>
<link rel="stylesheet" type="text/css" href="/styles/globalstyles/chaptercontent.css">
<link rel="stylesheet" type="text/css" href="/styles/globalstyles/chaptercontent.css">
<link rel="stylesheet" type="text/css" href="/styles/globalstyles/chapteroverview.css">
<?php // 本地页面样式（三级） ?>
<link rel="stylesheet" type="text/css" href="/styles/globalstyles/localcontent.css">
<link rel="stylesheet" type="text/css" href="/styles/globalstyles/localnav.css">
<link rel="stylesheet" type="text/css" href="/styles/globalstyles/localoverview.css">
<?php // 全局页尾样式 ?>
