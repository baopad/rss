...
$CONFIG = '{"lang":"zh","error_reporting":true,"show_hidden":true,"hide_Cols":true,"calc_folder":true}';

/**
 * File Manager
 * info@paotung.org
 * https://github.com/baopad
 */
...
// Generate secure password hash - https://github.com/baopad/
$auth_users = array(
    ...
    <div class="container h-100">
        <div class="row justify-content-md-center h-100">
            <div class="card-wrapper">
                ...
                <div class="footer text-center">&mdash;&mdash; &copy;<a href="https://github.com/baopad/filemanager" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">filemanager</a>&mdash;&mdash;</div>
            </div>
        </div>
    </div>
</section>
...
<!--***********************上传页面*********************-->
<main id="localoverview">
    <div id="lo-content" class="mb-2 fm-upload-wrapper">
        <div class="lo-header">
            <ul class="lo-header-case nav-tabs card-header-tabs" style="display: flex;">
        ...
        <div class="lo-list">
            <ul class="lo-list-case" style="flex-direction: column;">
                <li class="lo-list-item">
                    <div class="lo-list-item-case">
                        <p><a href="?p=<?php echo FM_PATH ?>" style="float: right;"><i class="fa fa-chevron-circle-left go-back"></i><?php echo lng('Back')?></a><?php echo lng('DestinationFolder') ?>:<?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?></p>
                    </div>
                </li>
                <li class="lo-list-item">
                    <div class="lo-list-item-case">
                ...
                <li class="lo-list-item">
                    <div class="lo-list-item-case upload-url-wrapper card-tabs-container hidden" id="urlUploader">
    ...
    <div id="lo-content">
        <div class="lo-header">
            <div class="lo-header-case">
                <h3><?php echo lng('Copying') ?></h3>
            </div>
        </div>
        <div class="lo-list">
            <form action="" method="post" class="lo-list-case"  style="flex-direction: column;">
                <input type="hidden" name="p" value="<?php echo fm_enc(FM_PATH) ?>">
                ...
                <div class="lo-list-item">
                    <div class="lo-list-item-case">
                        <p><?php echo lng('Files') ?>:<b><?php echo implode('</b>, <b>', $copy_files) ?></b></p>
                    </div>
                </div>
                <div class="lo-list-item">
                    <div class="lo-list-item-case">
                        <p><?php echo lng('SourceFolder') ?>:<?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?><br>
...
<div id="localoverview">
    <div id="lo-content">
        <div class="lo-header">
            <div class="lo-header-case">
                <h3><?php echo lng('Copying') ?><b>Copying</b></h3>
            </div>
        </div>
        <div class="lo-list">
            <div class="lo-list-case"  style="flex-direction: column;">
                <div class="lo-list-item">
                    <div class="lo-list-item-case">
                        <p>Source path:<?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . $copy)) ?><br>
                ...
                <div class="lo-list-item">
                    <div class="lo-list-item-case">
                        <div style="display: inline-block;padding: 0 8px;"><b><a href="?p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1"><i class="fa fa-check-circle"></i>Copy</a></b></div>
                        <div style="display: inline-block;padding: 0 8px;"><b><a href="?p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1&amp;move=1"><i class="fa fa-check-circle"></i>Move</a></b></div>
                        <div style="display: inline-block;padding: 0 8px;"><b><a href="?p=<?php echo urlencode(FM_PATH) ?>"><i class="fa fa-times-circle"></i>Cancel</a></b></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="lo-content">
        ...
        <div class="lo-list">
            <ul class="lo-list-case"  style="flex-direction: column;">
                <li class="lo-list-item">
                    <div class="lo-list-item-case">
                        <div class="lo-list-item-case"><a href="https://github.com/baopad/filemanager/wiki" target="_blank"><i class="fa fa-question-circle"></i><?php echo lng('Help Documents') ?></a></div>
                    </div>
                </li>
                <li class="lo-list-item">
                    <div class="lo-list-item-case">
                        <div class="lo-list-item-case"><a href="https://github.com/baopad/filemanager/issues" target="_blank"><i class="fa fa-bug"></i><?php echo lng('Report Issue') ?></a></div>
                    </div>
                </li>
                <li class="lo-list-item">
                    <div class="lo-list-item-case">
                        <div class="lo-list-item-case"><a href="javascript:latest_release_info('<?php echo VERSION; ?>');"><i class="fa fa-link"></i><?php echo lng('Check Latest Version') ?></a></div>
                    </div>
                </li>
                <?php if(!FM_READONLY) { ?>
                <li class="lo-list-item">
                    <div class="lo-list-item-case">
                        <div class="lo-list-item-case"><a href="javascript:show_new_pwd();"><i class="fa fa-lock"></i><?php echo lng('Generate new password hash') ?></a></div>
                    </div>
                </li>
                <?php } ?>
            </ul>
...
<div id="localoverview">
    <div id="lo-content">
        <div class="lo-header">
            <div class="lo-header-case">
                <h6 class="card-header"><i class="fa fa-exclamation-circle"></i>文件浏览（无多语言）</h6>
            </div>
        </div>
        <div class="lo-list">
            <ul class="lo-list-case"  style="flex-direction: column;">
                ...
                <li class="lo-list-item">
                    <div class="lo-list-item-case">
                        <div style="border: 2px solid rgba(150,150,150,1.00)">
                            <?php
                            }
                            if ( $is_onlineViewer ) {
...
<main id="localoverview">
    <div id="lo-content">
        <div class="lo-header">
            <div class="lo-header-case">
                <h6 class="card-header"><i class="fa fa-exclamation-circle"></i>文档编辑（无多语言）</h6>
            </div>
        </div>
        <div class="lo-list">
            <div class="lo-list-case"  style="display: inline-flex"><span class=" "><a title="Back" class="btn btn-sm btn-outline-primary" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;view=<?php echo urlencode($file) ?>"><i class="fa fa-reply-all"></i><?php echo lng('Back') ?></a></span><span class=" "><a title="Backup" class="btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="backup('<?php echo urlencode(trim(FM_PATH)) ?>','<?php echo urlencode($file) ?>')"><i class="fa fa-database"></i><?php echo lng('BackUp') ?></a></span>
                <?php if ($is_text) { ?>
                <?php if ($isNormalEditor) { ?>
                <span class=" "><a title="Advanced" class="btn btn-sm btn-outline-primary" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>&amp;env=ace"><i class="fa fa-pencil-square-o"></i><?php echo lng('AdvancedEditor') ?></a></span><span class=" ">
                ...
                <?php } else { ?>
                <span class="active"><a title="Plain Editor" class="btn btn-sm btn-outline-primary" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>"><i class="fa fa-text-height"></i><?php echo lng('NormalEditor') ?></a></span><span class=" ">
        ...
        <div class="lo-list">
            <?php if (!$isNormalEditor) { ?>
            <div class="lo-list-case" style="display: inline-flex">
        ...
        <div class="lo-list">
            ...
            <table id="main-table"  class="**lo-list-case">
                ...
                <tr>
                    ...
                    <?php endif; ?>
                    <td class="inline-actions"><a title="<?php echo lng('Preview') ?>" href="<?php echo $filelink.'&quickView=1'; ?>" data-toggle="lightbox" data-gallery="gallery" data-title="<?php echo fm_convert_win($f) ?>" data-max-width="100%" data-width="100%"><i class="fa fa-eye"></i></a>
                        <?php if (!FM_READONLY): ?>
...
/**
 * Show page header in Login Form   *********************************** 登录前页面******************************
 */
